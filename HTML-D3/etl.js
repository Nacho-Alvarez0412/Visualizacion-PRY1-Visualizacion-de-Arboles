const URL =
	"https://oec.world/olap-proxy/data?cube=trade_i_baci_a_92&Exporter+Country=nacri&drilldowns=HS4&measures=Trade+Value&parents=true&Year=2019&sparse=false&locale=en&q=Trade Value";

let CHART_DATA;

function formatData(data) {
	formattedData = { name: "Total Exports", children: [] };
	sections = { "Section ID": 0, name: "", children: [] };
	leaves = { "HS2 ID": 0, name: "", children: [] };

	data.forEach((element) => {
		leaf = {
			"HS4 ID": element["HS4 ID"],
			name: element.HS4,
			"Trade Value": element["Trade Value"],
		};
